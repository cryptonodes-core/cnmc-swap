**Develop Version, not for production now!** The CNMC swap contract has been updated to specify the
...
how to use them safely, and an example swap between Cryptonodes and Bitcoin.
...
For simplicity, we assume the initiator wishes to trade Bitcoin for Cryptonodes with
the participant.  The initiator can also trade Cryptonodes for Bitcoin and the steps
...
the participant's Cryptonodes contract, thereby revealing the secret to the
participant.  The secret is then extracted from the initiator's redeeming Cryptonodes
...
party A (the initiator) wishes to trade Bitcoin for Cryptonodes, party B (the
participant) must provide their Bitcoin address and the initiator must provide
the participant their Cryptonodes address.
...
B now informs A that the Cryptonodes contract transaction has been created and
...
from the Cryptonodes contract.  This step involves publishing a transaction which
...
Now that A has withdrawn from the Cryptonodes contract and revealed the secret, B
must extract the secret from this redemption transaction.  B may watch a block
explorer to see when the Cryptonodes contract output was spent and look up the
...
| Cryptonodes contract created by B | [a51a7ebc178731016f897684e8e6fbbd65798a84d0a0bd78fe2b53b8384fd918](https://testnet.decred.org/tx/a51a7ebc178731016f897684e8e6fbbd65798a84d0a0bd78fe2b53b8384fd918) |
| A's Cryptonodes redemption | [53c2e8bafb8fe36d54bbb1884141a39ea4da83db30bdf3c98ef420cdb332b0e7](https://testnet.decred.org/tx/53c2e8bafb8fe36d54bbb1884141a39ea4da83db30bdf3c98ef420cdb332b0e7) |
...
| Cryptonodes contract created by B | https://testnet.decred.org/api/rawtx/a51a7ebc178731016f897684e8e6fbbd65798a84d0a0bd78fe2b53b8384fd918 |
...
| Description | Link to raw transaction |
| - | - |
| Cryptonodes contract created by A | [fdd72f5841414a9c8b4a188a98a4d484df98f84e1c120e1ed59a66e51e8ae90c](https://mainnet.decred.org/tx/fdd72f5841414a9c8b4a188a98a4d484df98f84e1c120e1ed59a66e51e8ae90c) |
...
| B's Cryptonodes redemption | [49245425967b7e39c1eb27d261c7fe972675cccacff19ae9cc21f434ccddd986](https://mainnet.decred.org/tx/49245425967b7e39c1eb27d261c7fe972675cccacff19ae9cc21f434ccddd986) |
## License
